...
<head>
    ...
    <!-- Lien CSS personel -->
    <link rel="stylesheet" href="../lib/css/admin-style.css">
                ...
                <div class="col-md-2 text-center">
                    <div>
                        <a href="admin/connexion.php">
                             <button class="bouton_vert badge-pill mt-4" target="_blank"><i class="fas fa-clock"></i> Inscription/          <br>Connexion
                             </button></a>
                    </div>
                </div>           
